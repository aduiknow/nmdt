...
\vskip 0.4cm\vskip 0.4cm
+ Kết quả trong \textit{git log} là:\vskip 0.4cm
...
- Giả sử bạn đã chỉnh sửa hai tệp và muốn commit từng chỉnh sửa riêng, nhưng bạn vô tình gõ \textit{git add *} và tổ chức (staged) cả hai\vskip 0.4cm
